...
plot_p_vs_x(p_logistic(data_01$df), data_01$df$pblack, "pblack")
plot_p_vs_x(p_logistic(data_01$df), data_01$df$median_hhincome, "median_hhincome")
plot_p_vs_x(p_logistic(data_01$df), as.factor(data_01$df$red0), "red state")

plot_p_vs_x(p_logistic(data_02$df), data_02$df$pblack, "pblack")
plot_p_vs_x(p_logistic(data_02$df), data_02$df$median_hhincome, "median_hhincome")
plot_p_vs_x(p_logistic(data_02$df), as.factor(data_02$df$red0), "red state")

plot_p_vs_x(p_logistic(data_03$df), data_03$df$pblack, "pblack")
plot_p_vs_x(p_logistic(data_03$df), data_03$df$median_hhincome, "median_hhincome")
plot_p_vs_x(p_logistic(data_03$df), as.factor(data_03$df$red0), "red state")
```